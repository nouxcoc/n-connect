...
function getCourseById(courses, id) {
  const course = courses.filter(course => course._id == id);
...
const connectedApp = connect(mapStateToProps, mapDispatchToProps)(ManageCoursePage);
export { connectedApp as ManageCoursePage };
